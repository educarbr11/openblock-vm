...
const ptBrCommonSuffixes = {
    ...
    'pins.setDigitalOutput': 'definir pino digital [PIN] para [LEVEL]',
    'pins.setPwmOutput': 'definir pino analógico (PWM) [PIN] para [OUT]',
    'pins.esp32SetPwmOutput': 'definir pino analógico (PWM) [PIN] para [OUT]',
    'pins.esp32SetDACOutput': 'definir a saída DAC do pino [PIN] para [OUT]',
    'pins.readDigitalPin': 'ler pino digital [PIN]',
    'pins.readAnalogPin': 'ler pino analógico [PIN]',
    'pins.esp32ReadTouchPin': 'ler o pino touch [PIN]',
    'pins.setServoOutput': 'definir servo motor no pino [PIN] para [OUT]',
    'pins.esp32SetServoOutput': 'definir servo motor no pino [PIN] para [OUT]',
    ...
    'pins.setTempo': 'definir ritmo em [TEMPO] bpm',
