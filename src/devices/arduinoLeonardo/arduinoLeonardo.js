...
class OpenBlockArduinoLeonardoDevice {
    ...
    get DISTANCE_UNIT_MENU () {
        return [
            {
                text: formatMessage({
                    id: 'arduinoLeonardo.distanceUnitMenu.cm',
                    default: 'cm',
            ...
            {
                text: formatMessage({
                    id: 'arduinoLeonardo.distanceUnitMenu.inch',
                    default: 'inch',
        ...
        return applyDeviceTheme([
            {
                ...
                blocks: [
                    ...
                    '---',
                    {
                        ...
                        text: formatMessage({
                            id: 'arduinoLeonardo.pins.playToneForSeconds',
                            default: 'play sound on pin [PIN] note [NOTE] for [SECONDS] seconds',
                            description: 'arduinoLeonardo play tone for seconds'
                        }),
                        blockType: BlockType.COMMAND,
                        arguments: {
                            PIN: {
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            id: 'arduinoLeonardo.pins.playToneForBeat',
                            default: 'play sound on pin [PIN] note [NOTE] for [BEAT] beat',
                            description: 'arduinoLeonardo play tone for beat'
                        }),
                        blockType: BlockType.COMMAND,
                        arguments: {
                            PIN: {
                    ...
                    },
                    {
                        opcode: 'setTempo',
                        text: formatMessage({
                            id: 'arduinoLeonardo.pins.setTempo',
                            default: 'set tempo to [TEMPO] bpm',
                            description: 'arduinoLeonardo set tempo in beats per minute'
                        }),
                        blockType: BlockType.COMMAND,
                        arguments: {
                            TEMPO: {
                    ...
                    },
                    {
                        opcode: 'stopTone',
                        text: formatMessage({
                            id: 'arduinoLeonardo.pins.stopTone',
                            default: 'stop sound on pin [PIN]',
                            description: 'arduinoLeonardo stop tone'
                        }),
                        blockType: BlockType.COMMAND,
                        arguments: {
                            PIN: {
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            id: 'arduinoLeonardo.pins.readUltrasonicDistance',
                            default: 'read ultrasonic distance TRIG [TRIG] ECHO [ECHO] in [UNIT]',
                            description: 'arduinoLeonardo read ultrasonic distance'
                        }),
                        blockType: BlockType.REPORTER,
                        arguments: {
                            TRIG: {
