...
class OpenBlockArduinoUnoR4WifiDevice {
    ...
    get DISTANCE_UNIT_MENU () {
        return [
            {
                text: formatMessage({
                    id: 'arduinoUnoR4Wifi.distanceUnitMenu.cm',
                    default: 'cm',
            ...
            {
                text: formatMessage({
                    id: 'arduinoUnoR4Wifi.distanceUnitMenu.inch',
                    default: 'inch',
        ...
        return applyDeviceTheme([
            {
                ...
                blocks: [
                    ...
                    '---',
                    {
                        ...
                        text: formatMessage({
                            id: 'arduinoUnoR4Wifi.pins.playToneForSeconds',
                            default: 'play sound on pin [PIN] note [NOTE] for [SECONDS] seconds',
                            description: 'arduinoUnoR4Wifi play tone for seconds'
                        }),
                        blockType: BlockType.COMMAND,
                        arguments: {
                            PIN: {
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            id: 'arduinoUnoR4Wifi.pins.playToneForBeat',
                            default: 'play sound on pin [PIN] note [NOTE] for [BEAT] beat',
                            description: 'arduinoUnoR4Wifi play tone for beat'
                        }),
                        blockType: BlockType.COMMAND,
                        arguments: {
                            PIN: {
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            ...
                            description: 'arduinoUnoR4Wifi stop tone'
                        }),
                        blockType: BlockType.COMMAND,
                        arguments: {
                            PIN: {
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            id: 'arduinoUnoR4Wifi.pins.readUltrasonicDistance',
                            default: 'read ultrasonic distance TRIG [TRIG] ECHO [ECHO] in [UNIT]',
                            description: 'arduinoUnoR4Wifi read ultrasonic distance'
                        }),
                        blockType: BlockType.REPORTER,
                        arguments: {
                            TRIG: {
                ...
                blocks: [
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            ...
                            description: 'arduinoUnoR4Wifi serial read available data'
                        }),
                        blockType: BlockType.REPORTER,
                        disableMonitor: true,
                        programMode: [ProgramModeType.UPLOAD]
